            ...
            <div class="row mb-3">
                <div class="container ">
                    <div class="card-header">
                        <h2 class="mb-0">Approved Vendors</h2>
                    </div>
                        ...
                        <table id="productTable" style="width:100%" class="table table-striped table-bordered ">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th scope="col" style="color:white;font-size:medium;text-align:center;text-transform:capitalize;">Action</th> <!-- Action column for Deactivate button -->
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('approval.vendor.updateStatus', $vendor->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <input type="hidden" name="status" value="deactivated"> <!-- Hidden field for the status -->
                                            <button type="submit" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Reject">
                                                <i class="fas fa-ban"></i> <!-- Add the ban icon -->
                                            </button>
                                        </form>
                                    </td>
