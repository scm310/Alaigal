            ...
            <div class="row mb-3">
                <div class="container ">
                    <div class="card-header">
                        <h2 class="mb-0">Rejected Vendors</h2>
                    </div>
                    <div class="table-responsive">
                        <table id="productTable" style="width:100%" class="table table-striped table-bordered ">
                            <thead class="bg-primary">
                                <tr>
                                    <th scope="col" style="color:white;font-size:medium;text-align:center;text-transform:capitalize;">S.No.</th> <!-- Added S.No. column -->
                                    ...
                                    <th scope="col" style="color:white;font-size:medium;text-align:center;text-transform:capitalize;">Action</th> <!-- Action column for Approve button -->
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Approve button form -->
                                        <form action="{{ route('approval.vendor.updateStatus', $vendor->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <input type="hidden" name="status" value="approved"> <!-- Hidden field for the status -->
                                            <button type="submit" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Approve Vendor">
                                                <i class="fas fa-check"></i> <!-- Add the check icon -->
                                            </button>
                                        </form>
                                    </td>
