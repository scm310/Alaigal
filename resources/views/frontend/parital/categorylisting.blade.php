...
<style>
    ...
    .marquee-content {
        ...
        animation: smoothMarquee 2s linear infinite;
    }
    ...
    .custom-list {
        ...
        border-radius: 6px;
        background-color: rgb(255, 218, 250) !important;
...
<style>
    ...
    .nav-control {
    background-color: #A87676; /* Light Pink */
...
.nav-control:hover {
    background-color: #A87676; /* Slightly darker pink on hover */
}

.nav-control:disabled {
    background-color: #A87676; /* Soft pastel pink for disabled state */
    cursor: not-allowed;
    opacity: 0.6;
}
...
<style>
    @media (max-width: 768px) {
        ...
        .dropdown-menu, .child-category-list {
            display: none !important;
        }
    }
</style>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light mainnavbar">
    <div class="container-fluid">
        ...
        <!-- Category List -->
        <ul class="navbar-nav category-list d-flex flex-row">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="child-category-list">
                            @foreach($subcategory->childcategories->sortBy('name') as $childcategory)
                            <li>
